...
<Box>
  {uploadedPhoto ? (
      ...
      <Box><DetailsInvoiceColumn/></Box>
    </Box>
    <Box className={style.yellow}></Box>
    <Box className="flex justify-between items-center h-full w-full">
    {/* details start */}

    <Box className={style.shipdata}>
    <Box className="mt-5">
        <ul><Grid container className="container" spacing={2}>
            <Grid item xs={6}>
              <Box className="mb-2">
    ...
    <Box  className={style.HeaderInvoicemain}>  
    <Box className={style.invoivceInp}><input className={style.invoivceInp1} type="text"  value="INVOICES" id="name"/></Box>
    <Grid spacing={2} className={style.HeaderInvoice}>
            ...
            <Box className={style.flex}>
             <Box className={style.date1}>
              <input
                className={style.invoiceHeaderInput21}
                type="text"
              ...
              />
              <input
                className={style.invoiceHeaderInput22}
                type="date"
                value={InvoiceDate}
