...
const TableItem = (prop) => {
  ...
  const [inputFields, setInputFields] = useState([
    {fullName: "", quantity: "", price: "",amount: 0,},]);
  ...
  return (
    <div>
      <Box>
        <table className="table theme-table mb-2 w-full mt-5">
          {/* Table header */}
...
//             <Grid item xs={6}>
//               <Box className="mb-2">
//                 <LIghtInputfeild  className={style.LightInputField} value="Bill to" placeholder="Bill to" />
//               </Box>
...
//               <Box className="mb-2">
//                 <LIghtInputfeild  className={style.LightInputField} value="Ship to" placeholder="Ship to"/>
//               </Box>
//               <li className={style.list}>
