...
const Privecy = () => {
  return (
    <div>
    <NavScrollExample/>
    <HeadinPera Heading="Privacy Policy" peragraph="Privacy Policy for our product"/>
  ...
  <p className={style.pera}>Lets Make Invoice is an invoice generator that lets you easily create professional invoices by selecting a template, filling in invoice details, and generating a PDF. The best part is, you dont need to provide any account or payment information.</p>
  
  <h3 className={style.h3}> Your Content</h3>
  <p className={style.pera}>
When you use the Service, you are responsible for the content you create, such as your company details, products or services, and payment terms. You must ensure that your content does not violate any third-party rights or applicable laws.
</p>
 <h3 className={style.h3}>Our Intellectual Property</h3>
<p className={style.pera}>The Service and all its contents, such as the website design, templates, logos, and software, are owned by Lets Make Invoice or its licensors and are protected by Indian and international copyright laws. You may not use our intellectual property without our prior written consent.</p>
  <h3 className={style.h3}>Limitations of Liability</h3>
  <p className={style.pera}>We strive to make our Service reliable and user-friendly, but there may be times when its not working perfectly. We cannot guarantee that the Service will always be error-free, uninterrupted, or completely secure. To the fullest extent permitted by law, we make no promises or warranties about the Service, including any implied warranties of merchantability and fitness for a particular purpose. In the event that something goes wrong with the Service, we will not be responsible for any damages that you or anyone else may suffer. This includes indirect, incidental, special, or consequential, damages, which could result from your use of the Service or any content accessed through the Service. Governing Law and Dispute Resolution.
